...
import { ProductA } from '../../../product/entity/ProductA/product.entity'
...
describe('Order service unit tests', () => {
  ...
  it('should able to get total of all orders', () => {
    ...
    const product1 = new ProductA(v4(), 'Product 1', 5)
    const product2 = new ProductA(v4(), 'Product 2', 3)
    const product3 = new ProductA(v4(), 'Product 3', 10)
